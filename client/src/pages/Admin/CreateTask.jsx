...
const CreateTask = () => {
  ...
  const updateTask = async () => {
    ...
    try {
        ...
        const response=axiosInstance.put(API_PATHS.TASKS.UPDATE_TASK(taskId),{
          ...taskData,
          dueDate:new Date(taskData.dueDate).toISOString(),
          todoChecklist:todolist,
        });
  ...
  const handleSubmit = async () => {
    ...
    if (taskData.assignedTo?.length === 0) {
      setError("Task no assigned to any member");
      return;
    }
      ...
      <div className="mt-5">
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            ...
            <div className="mt-3">
              <label className="text-xs font-medium text-shadow-slate-600">
                Description
              </label>
              <textarea
